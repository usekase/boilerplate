 ...
 * ============
 *
 * This page displays the Clerk sign-in component.
...
// Only import SignIn if Clerk is configured
let SignIn: React.ComponentType<{ appearance?: Record<string, unknown> }> | null = null;
          ...
          <Card className="max-w-md">
            ...
            <CardContent className="space-y-4">
              <p className="text-gray-600">
                To enable sign-in, add your Clerk keys to <code className="bg-gray-100 px-1 rounded">.env.local</code>:
              </p>
